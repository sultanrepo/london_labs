var multiSelectBasic = document.getElementById("multiselect-basic"),
    ...
    autoCompleteFruit = (multiSelectOptGroup && multi(multiSelectOptGroup, {
        enable_search: !0
    }), document.getElementById("multiselect-optiongroup-abc")),
    autoCompleteFruits = (autoCompleteFruit && multi(autoCompleteFruit, {
        enable_search: !0
    }), new autoComplete({
        selector: "#autoCompleteFruits",
        ...
        events: {
            input: {
                selection: function (e) {
                    ...
                    autoCompleteFruits.input.value = e
                }
            }
        }
    })),
