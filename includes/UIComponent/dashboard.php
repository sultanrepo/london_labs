                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <h5 class="text-success fs-xs mb-0"><i class="ri-arrow-right-up-line fs-sm align-middle"></i> +19.07 %</h5>
                                    ...
                                    <div class="card shadow-none border-bottom rounded-0 mb-0">
                                        <div class="card-body">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <h5 class="text-success fs-xs mb-0"><i class="ri-arrow-right-up-line fs-sm align-middle"></i> +8.13 %</h5>
                                                    <p class="text-muted mb-0">than last week</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card shadow-none border-end-md rounded-0 mb-0">
                                        <div class="card-body">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <h5 class="text-danger fs-xs mb-0"><i class="ri-arrow-right-down-line fs-sm align-middle"></i> +2.01 %</h5>
                                                    <p class="text-muted mb-0">than last week</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card shadow-none border-top border-top-md-0 rounded-0 mb-0">
                                        <div class="card-body">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <h5 class="text-success fs-xs mb-0"><i class="ri-arrow-right-up-line fs-sm align-middle"></i> +10.42 %</h5>
                                                    <p class="text-muted mb-0">than last week</p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-3">
                                <div class="card-body border-start-xl border-top border-top-xl-0 border-2 h-100">
                                    <div>
                                        ...
                                        <h4>
                                            $750.36M <small class="text-success fs-sm fw-normal"><i class="ph-arrow-up align-baseline"></i> 2.17%</small>
                                        </h4>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <h4>
                                            $7,45,123 <small class="text-danger fs-sm fw-normal"><i class="ph-arrow-down align-baseline"></i> -1.36%</small>
                                        </h4>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div>
                                        <ul class="list-unstyled vstack gap-2">
                                            <li class="p-2 rounded"><i class="ri-checkbox-blank-circle-fill text-primary align-bottom me-1"></i> United States <span class="float-end">15,364</span></li>
                                            <li class="bg-light-subtle p-2 rounded"><i class="ri-checkbox-blank-circle-fill text-secondary align-bottom me-1"></i> Greenland <span class="float-end">12,387</span></li>
                                            <li class="p-2 rounded"><i class="ri-checkbox-blank-circle-fill text-info align-bottom me-1"></i> Serbia <span class="float-end">9,123</span></li>
                                            <li class="bg-light-subtle p-2 rounded"><i class="ri-checkbox-blank-circle-fill text-success align-bottom me-1"></i> Russia <span class="float-end">7,108</span></li>
                                            <li class="p-2 rounded"><i class="ri-checkbox-blank-circle-fill text-danger align-bottom me-1"></i> Brazil <span class="float-end">6,731</span></li>
                                            <li class="bg-light-subtle p-2 rounded"><i class="ri-checkbox-blank-circle-fill text-warning align-bottom me-1"></i> Sydney <span class="float-end">3,023</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <ul class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted">
                                                    ...
                                                    <li><i class="ph-shopping-cart align-baseline"></i> 936</li>
                                                </ul>
                                            </div>
                                            <div class="text-end">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <ul class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted">
                                                    ...
                                                    <li><i class="ph-shopping-cart align-baseline"></i> 1420</li>
                                                </ul>
                                            </div>
                                            <div class="text-end">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <ul class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted">
                                                    ...
                                                    <li><i class="ph-shopping-cart align-baseline"></i> 1348</li>
                                                </ul>
                                            </div>
                                            <div class="text-end">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <ul class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted">
                                                    ...
                                                    <li><i class="ph-shopping-cart align-baseline"></i> 1540</li>
                                                </ul>
                                            </div>
                                            <div class="text-end">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <ul class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted">
                                                    ...
                                                    <li><i class="ph-shopping-cart align-baseline"></i> 985</li>
                                                </ul>
                                            </div>
                                            <div class="text-end">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <ul class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted">
                                                    ...
                                                    <li><i class="ph-shopping-cart align-baseline"></i> 763</li>
                                                </ul>
                                            </div>
                                            <div class="text-end">
